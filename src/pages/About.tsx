...
const About = () => {
  const stats = [
    { icon: <Server className="h-8 w-8 text-blue-600" />, number: "2000+", label: "Websites Hosted" },
    { icon: <Users className="h-8 w-8 text-blue-600" />, number: "99.9%", label: "Uptime Guarantee" },
    { icon: <Award className="h-8 w-8 text-blue-600" />, number: "22+", label: "Years Combined Experience" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We're a global web hosting company committed to providing reliable, 
            secure, and affordable hosting solutions with exceptional worldwide support and competitive regional pricing.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  ...
                  businesses worldwide with world-class web hosting services at competitive regional prices, 
                  without the complexity and hidden costs often associated with traditional providers.
                </p>
                <p>
                  We understand the unique challenges faced by businesses in the digital space across different regions. 
                  That's why we offer transparent regional pricing, support in your timezone, 
                  and hosting solutions optimized for global performance.
                </p>
                <p>
                  Today, we proudly serve thousands of websites globally, from small local 
            ...
            <div className="bg-blue-50 p-8 rounded-xl">
              ...
              <p className="text-gray-700 mb-6">
                To empower businesses worldwide with reliable, secure, and affordable web hosting 
                solutions, backed by exceptional global support and transparent regional pricing.
              </p>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Values</h3>
              <ul className="space-y-2 text-gray-700">
                <li>• Transparency in all our dealings</li>
                <li>• Reliability you can count on</li>
                <li>• Global support that understands your business</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-blue-100">
                Global support team that understands your business and timezone
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-3">Regional Pricing</h3>
              <p className="text-blue-100">
                Transparent regional pricing adapted to your location with no hidden fees
              </p>
            </div>
            <div>
