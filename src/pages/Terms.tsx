    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading terms information...</p>
        </div>
      </div>
    );
  }
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                <ul className="space-y-2">
                  <li>• All prices are in {pricing.currency}, excluding applicable taxes</li>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 space-y-4">
              <div>
                ...
                <ul className="text-gray-700 space-y-1">
                  <li>• Business Hosting (5GB): From {formatPrice(pricing.hostingPlans.business)} per year</li>
                  <li>• Pro Hosting (15GB): From {formatPrice(pricing.hostingPlans.pro)} per year</li>
                  <li>• Enterprise Hosting (50GB): From {formatPrice(pricing.hostingPlans.enterprise)} per year</li>
              ...
              <div>
                ...
                <ul className="text-gray-700 space-y-1">
                  <li>• .com/.net/.org Registration: From {formatPrice(pricing.domainServices.international)} per year</li>
                  <li>• Country-specific domains: From {formatPrice(pricing.domainServices.countrySpecific)} per year</li>
                  <li>• Domain Transfer: From {formatPrice(pricing.domainServices.transfer)} (one-time fee)</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-gray-700 space-y-1">
                  <li>• Basic Shopfront: From {formatPrice(pricing.ecommerceServices.basic)} (up to 10 products)</li>
                  <li>• Standard Shopfront: From {formatPrice(pricing.ecommerceServices.standard)} (up to 50 products, includes payment gateway)</li>
                  <li>• Premium Shopfront: From {formatPrice(pricing.ecommerceServices.premium)} (custom design with advanced UX/UI)</li>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <ul className="text-yellow-700 text-sm mt-1 space-y-1">
                      <li>• Prices vary by region and may include applicable taxes</li>
                      <li>• Annual hosting and domain fees are payable upfront</li>
                      <li>• Development projects require 50% deposit before work begins</li>
                      <li>• Payment methods: Credit Card, Bank Transfer, Digital Payments</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  We comply with international data protection regulations including GDPR and regional privacy laws.
          ...
          <section>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 space-y-4">
              <div>
                ...
                <p className="text-gray-700">
                  These Terms of Service are governed by international law and the laws of the jurisdiction
                  where services are provided. Disputes will be resolved through appropriate legal channels.
                </p>
              </div>
