        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-4">From {formatPrice(pricing.hostingPlans.business)}<span className="text-lg text-gray-600">/year</span></div>
              ...
              <button 
                onClick={() => (window as any).requestQuote?.('Business Hosting', `From ${formatPrice(pricing.hostingPlans.business)}/year`)}
                className="block w-full text-center bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200"
              >
                Choose Plan
              </button>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md border-2 border-blue-600 relative">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-4">From {formatPrice(pricing.hostingPlans.pro)}<span className="text-lg text-gray-600">/year</span></div>
              <ul className="space-y-2 mb-6">
              ...
              <button 
                onClick={() => (window as any).requestQuote?.('Pro Hosting', `From ${formatPrice(pricing.hostingPlans.pro)}/year`)}
                className="block w-full text-center bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200"
              >
                Choose Plan
              </button>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-4">From {formatPrice(pricing.hostingPlans.enterprise)}<span className="text-lg text-gray-600">/year</span></div>
              <ul className="space-y-2 mb-6">
              ...
              <button 
                onClick={() => (window as any).requestQuote?.('Enterprise Hosting', `From ${formatPrice(pricing.hostingPlans.enterprise)}/year`)}
                className="block w-full text-center bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200"
              >
                Choose Plan
              </button>
      ...
      <section className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Join thousands of businesses worldwide who trust Ubani Hosting for their web presence.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
