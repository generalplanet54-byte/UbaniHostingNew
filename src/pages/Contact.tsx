...
const Contact = () => {
  ...
  // Function to handle quote requests with pre-filled form data
  const handleQuoteRequest = (service: string, price: string) => {
    setFormData({
      ...formData,
      subject: `Quote Request - ${service}`,
      message: `I would like to request a quote for ${service} (${price}). Please provide more details about this service and any additional information I should know.`
    });
  ...
  React.useEffect(() => {
    (window as any).requestQuote = handleQuoteRequest;
  }, []);
        ...
        <section className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">Yes! We offer free basic migration with new hosting accounts, or professional migration services starting at R2,500. <a href="/services" className="text-blue-600 hover:text-blue-800 underline">View our migration services</a>.</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">What payment methods do you accept?</h3>
              <p className="text-gray-600">We accept various payment methods including credit cards, bank transfers, and digital payments. Annual hosting fees are payable upfront, with 50% deposit required for development projects.</p>
            </div>
